...
@Test
@CucumberOptions(
        features = "src/test/resources/features/WarehouseFeatures/Departments.feature",
        ...
        , monochrome = true,
        tags = "@DepartmentsTest "
)

public class DepartmentsTestRunner extends AbstractTestNGCucumberTests {
    @Override
