...
@Test
@CucumberOptions(
        features = "src/test/resources/features/WarehouseFeatures/Designation.feature",
        ...
        , monochrome = true,
        tags = "@DesignationTest "
)

public class DesignationTestRunner extends AbstractTestNGCucumberTests {
    @Override
