...
@Test
@CucumberOptions(
        features = "src/test/resources/features/WarehouseFeatures/RolesandPermissions.feature",
        ...
        , monochrome = true,
        tags = " @RolesandPermissionsTest "
)

public class RolesandPersmissionsDataRunner extends AbstractTestNGCucumberTests {
    @Override
