...
@Test
@CucumberOptions(
        features = "src/test/resources/features/WarehouseFeatures/PurchaseOrders.feature",
        ...
        , monochrome = true,
        tags = "@PurchaseOrdersTest "
)

public class PurchaseOrdersTestRunner extends AbstractTestNGCucumberTests {
    @Override
